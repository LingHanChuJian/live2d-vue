...
class ModelSettingJson {
  ...
  getHitAreaID (n) {
    if (this.json[this.HIT_AREAS] == null ||
            this.json[this.HIT_AREAS][n] == null) { return null }
  ...
  getMotionNum (name) {
    if (this.json[this.MOTION_GROUPS] == null ||
            this.json[this.MOTION_GROUPS][name] == null) { return 0 }
  ...
  getMotionFile (name, n) {
    if (this.json[this.MOTION_GROUPS] == null ||
            ...
            this.json[this.MOTION_GROUPS][name][n] == null) { return null }
  ...
  getMotionSound (name, n) {
    if (this.json[this.MOTION_GROUPS] == null ||
            ...
            this.json[this.MOTION_GROUPS][name][n][this.SOUND] == null) { return null }
  ...
  getMotionFadeIn (name, n) {
    if (this.json[this.MOTION_GROUPS] == null ||
            this.json[this.MOTION_GROUPS][name] == null ||
            this.json[this.MOTION_GROUPS][name][n] == null ||
            this.json[this.MOTION_GROUPS][name][n][this.FADE_IN] == null) { return 1000 }
  ...
  getMotionFadeOut (name, n) {
    if (this.json[this.MOTION_GROUPS] == null ||
            this.json[this.MOTION_GROUPS][name] == null ||
            this.json[this.MOTION_GROUPS][name][n] == null ||
            this.json[this.MOTION_GROUPS][name][n][this.FADE_OUT] == null) { return 1000 }
    return this.json[this.MOTION_GROUPS][name][n][this.FADE_OUT]
  }

  getInitParamID (n) {
    if (this.json[this.INIT_PARAM] == null ||
            this.json[this.INIT_PARAM][n] == null) { return null }
